...
public class Run
{
    ...
    public static byte[] getClassFromSourceCode(String sourceCode) throws Exception {
        ...
        if (!result) {
            ...
            Iterator<Diagnostic<? extends JavaFileObject>> iterator = diagnostics.iterator(); if (iterator.hasNext()) { Diagnostic<? extends JavaFileObject> diagnostic = iterator.next();
