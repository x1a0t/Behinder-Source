...
public class FileManagerViewController {
    ...
    private void initDirTree() throws Exception {
        ...
        Image icon = new Image(new ByteArrayInputStream(Utils.getResourceData("images/drive.png")));
    ...
    private void initCurrentPathCombo() {
        ...
        ObservableList<String> pathList = FXCollections.observableArrayList(new String[]{currentPath});
    ...
    private void initFileListTableColumns() {
        ...
        ((TableColumn<List<SimpleStringProperty>, String>)tcs.get(1)).setComparator((o1, o2) -> {
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (item == null | empty) {
                        ...
                        if (type.equals("directory")) {
                            try {
                                icon = new Image(new ByteArrayInputStream(Utils.getResourceData("images/folder.png")));
                            ...
                            try {
                                icon = new Image(new ByteArrayInputStream(Utils.getResourceData("images/file.png")));
                                this.setGraphic(new ImageView(icon));
        ...
        for(int i = 0; i < rows.length(); ++i) {
            try {
                ...
                if (!name.equals(".") && !name.equals("..") && type.equals("directory")) {
                    Image icon = new Image(new ByteArrayInputStream(Utils.getResourceData("images/folder.png")));
