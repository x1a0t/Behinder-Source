...
public class PluginViewController
{
    ...
    private void loadPluginDetail(JSONObject pluginObj) {
        this.pluginNameLabel.setText(String.format(this.pluginNameLabel.getText(), new Object[] { pluginObj.getString("name"), pluginObj.getString("version") }));
        this.pluginAuthorLabel.setText(String.format(this.pluginAuthorLabel.getText(), new Object[] { pluginObj.getString("author") }));
        this.pluginLinkLabel.setText(String.format(this.pluginLinkLabel.getText(), new Object[] { pluginObj.getString("link") }));
        this.pluginCommentLabel.setText(String.format(this.pluginCommentLabel.getText(), new Object[] { pluginObj.getString("comment") }));
        String pathFormat = "file://%s/Plugins/%s/%s";
        try {
            String qrcodeFilePath = String.format(pathFormat, new Object[] { Utils.getSelfPath(), pluginObj.getString("name"), pluginObj.getString("qrcode") });
    ...
    private void addPluginBox(JSONObject pluginObj) throws Exception {
        ...
        String pathFormat = "file://%s/Plugins/%s/%s";
        String entryFilePath = String.format(pathFormat, new Object[] { Utils.getSelfPath(), pluginName, pluginObj.getString("entryFile") });
        String iconFilePath = String.format(pathFormat, new Object[] { Utils.getSelfPath(), pluginName, pluginObj.getString("icon") });
